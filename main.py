...
DATA_FILE = "data.json"
ADMIN_IDS = [123456789, 987654321]  # сюда вставь свои id
...
async def export_cmd(message: types.Message):
    ...
    if os.path.exists(DATA_FILE):
        ...
        await message.answer("Файл данных пока пуст.")
...
async def handle_message(message: types.Message):
    ...
    if step == "ask_name":
        ...
        if await check_subscription(user_id):
            ...
            await message.answer("✨ Отлично, подписка подтверждена! Начинаем курс.")
